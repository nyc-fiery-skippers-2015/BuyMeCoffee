...
User.create(name:Faker::Name.first_name , about: Faker::Lorem.paragraph , status: true, password: "123" , email: Faker::Internet.email  , linkedin: "donovanholness" , latitude: "25.0000," , longitude: "71.0000", image_url: "https://avatars1.githubusercontent.com/u/1297679?v=3&s=460")

User.create(name:Faker::Name.first_name , about: Faker::Lorem.paragraph , status: true, password: '123' , email: Faker::Internet.email  , linkedin: "donovanholness" , latitude: "18" , longitude: "76.8", image_url:"https://avatars3.githubusercontent.com/u/9508782?v=3&s=460")
